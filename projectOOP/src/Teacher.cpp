...
void Teacher::setTeacherId(int teacherID)
 ...
 Teacher::Teacher(string name,int age,string gender,string address,string phoneNumber,string email,int teacherID,string subject,float salary):Person(name,age,gender,address,phoneNumber,email)
 {
