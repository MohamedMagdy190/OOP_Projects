...
Student::Student(int studentId,float gpa,string grade)
 ...
 Student::Student(string name,int age,string gender,string address
                  ...
                  ,int studentId,float gpa,string grade):Person(name,age,gender,address,phoneNumber,email)
 {
     this->studentId=studentId;
     this->gpa=gpa;
     this->grade=grade;
 }
 void Student::input(string name,int age,string gender,string address,string phoneNumber,string email,int studentId,float gpa,string grade)
 {
